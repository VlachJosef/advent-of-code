...
solution1 :: Data -> Int
solution1 input = foldl (+) 0 $ map evaluate input where
  evaluate :: Array String -> Int
  evaluate xs = if length xs == length (nub xs) then 1 else 0

solution1Final :: Int
solution1Final = solution1 input

solution2 :: Data -> Int
solution2 input = foldl (+) 0 $ map evaluate input where
  evaluate :: Array String -> Int
  evaluate xs = if length xs == length (nub $ map (fromCharArray <<< sort <<< toCharArray) xs) then 1 else 0

solution2Final :: Int
solution2Final = solution2 input
